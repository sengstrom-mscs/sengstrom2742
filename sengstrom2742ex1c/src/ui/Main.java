...
public class Main {
    public static void main (String[] args){
        System.out.println("sengstrom2742ex1c: Composite Invoice Class");
        ...
        invoice1.addLineItem(new LineItem(2.0, "description1"));
        invoice1.addLineItem(new LineItem(3.0, "description1"));
        invoice1.addLineItem(new LineItem(4.0, "description1"));
