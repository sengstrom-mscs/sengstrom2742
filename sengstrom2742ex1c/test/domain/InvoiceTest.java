...
//        assertNotEquals(this.invoice1.getDueDate(), invoice2.getDueDate());
    ...
    void total() {
        double total1 = 0.00;
        double total2 = 100.00;
        double total3 = 200.00;
        double total4 = 300.00;
        assertNotEquals(total1, total4);
        assertNotEquals(total2,total3);
        assertEquals(total4, total2+total3);
    }
}
